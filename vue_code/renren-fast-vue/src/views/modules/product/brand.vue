<template>
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.key" placeholder="请输入品牌名或id" clearable></el-input>
      </el-form-item>
      <el-form-item>     
    ...
    <el-dialog title="关联分类" :visible.sync="cateRelationDialogVisible" width="30%">
      ...
      <!-- 关联分类列表 -->
      <el-table :data="categoryBrandRelationEntityList" style="width: 100%">
        <el-table-column prop="id" label="#"></el-table-column>
        <el-table-column prop="brandName" label="品牌名"></el-table-column>
        <el-table-column width="120px" prop="catalogName" label="分类名"></el-table-column>
...
export default {
  data() {
    return {
      ...
      dataListSelections: [],
      addOrUpdateVisible: false,   //新增或修改开关
  ...
  methods: {
    ...
    getCateRelation() {
      this.$http({
        ...
        this.categoryBrandRelationEntityList = data.categoryBrandRelationEntityList;
      });
    },
    // 获取品牌列表
    getDataList() {
    ...
    addOrUpdateHandle(id) {
      ...
      this.$nextTick(() => {
        this.$refs.addOrUpdate.init(id);   //附id时获取数据
      });
    },
    // 删除
    deleteHandle(id) {
