...
MySQL - 8.0.19 : Database - mall_pms
*********************************************************************
*/
...
CREATE TABLE `pms_attr` (
  ...
  `value_type` tinyint DEFAULT NULL COMMENT '允许单个值，还是多个值',
  ...
  PRIMARY KEY (`attr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品属性';

/*Data for the table `pms_attr` */

insert  into `pms_attr`(`attr_id`,`attr_name`,`search_type`,`icon`,`value_type`,`value_select`,`attr_type`,`enable`,`catalog_id`,`show_desc`) values 
(1,'屏幕尺寸',1,'无',0,'6.95英寸及以上;6.0-6.24英寸;6.85-6.94英寸;6.75-6.84英寸;6.65-6.74英寸;6.55-6.64英寸;6.45-6.54英寸',1,1,225,0),
(2,'充电功率',1,'无',0,'100W以上;50-100W;40-49W;30-39W;27-29W;20-26W;18-19W;12-17W;小于12W',1,1,225,0),
(3,'支持IPv6',1,'无',0,'支持;不支持',1,1,225,0),
(4,'电池容量',1,'无',0,'1200mAh以下;1200-1999mAh;2000-2999mAh;3000-3499mAh;3500-3749mAh;3750-3999mAh',1,1,225,0),
(5,'上市年份',0,'无',0,'2018年;2019年;2020年;2021年;2022年',1,1,225,0),
(6,'系统',1,'无',0,'Android;HarmonyOS 2;HarmonyOS 2.0.1;iOS;功能机;其他OS',1,1,225,0),
(7,'CPU型号',1,'无',0,'骁龙439;天玑1000plus;麒麟980;其他',1,1,225,0),
(8,'机身内存',1,'无',0,'1TB;640GB;8GB以下;16GB;32GB;64GB;128GB;256GB;512GB',0,1,225,0),
(9,'保修期',0,'无',0,'1年;2年;3年',1,1,225,0),
(10,'颜色',1,'无',0,'星光色;午夜色;粉色;蓝色;红色;绿色',0,1,225,0),
(21,'能效等级',1,'无',0,'一级能效;二级能效;三级能效;无能效等级',1,1,252,0),
(22,'门款式',1,'无',1,'T型门;对开门;十字对开门;多门;三门;双门;单门',1,1,252,0),
(23,'宽度',0,'无',0,'95cm以上;90.1-95cm;85.1-90cm;80.1-85cm;75.1-80cm;70.1-75cm;65.1-70cm',0,1,252,0),
(24,'制冷方式',1,'无',0,'半导体制冷;吸收式;风冷;风直冷;直冷',1,1,252,0),
(25,'总容积',0,'无',0,'325升;456升;520升',0,1,252,0);
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='属性&属性分组关联';
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='属性分组';

/*Data for the table `pms_attr_group` */

insert  into `pms_attr_group`(`attr_group_id`,`attr_group_name`,`sort`,`descript`,`icon`,`catalog_id`) values 
(0,'无分组',0,'零','无',0),
(1,'冰箱分组一',0,'冰箱分组','无',252),
(2,'冰箱分组二',0,'冰箱分组','无',252),
(3,'手机分组一',0,'手机分组','无',225),
(4,'手机分组二',0,'手机分组','无',225);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='品牌';

/*Data for the table `pms_brand` */

insert  into `pms_brand`(`brand_id`,`name`,`logo`,`descript`,`show_status`,`first_letter`,`sort`) values 
(1,'三星','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/d375bfcc-3e54-421b-863d-fbba3c00ff80_三星.png','三星手机',1,'a',0),
(2,'IPhone','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/020fbc83-e141-4417-811b-27b6ff7a1c2d_IPhone.png','IPhone',1,'b',0),
(3,'华为','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/427ecf10-36a0-4121-839f-4ad816893e00_华为.png','华为手机',1,'c',0),
(4,'小米','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/25f173bb-a054-4d17-8b4b-ed4080db1aec_小米.png','小米手机',1,'d',0),
(5,'海尔','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/23f626fd-5262-420a-8618-02c8e1121f18_海尔.png','海尔家电',1,'e',0),
(6,'SIEMENS','https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/86c878b5-71aa-4fb3-8311-6542477e5b4e_SIEMENS.png','SIEMENS家电',1,'f',0);
...
(1423,'面包车（二手）',164,3,1,0,'11',NULL,0);
...
CREATE TABLE `pms_category_brand_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='品牌分类关联';

/*Data for the table `pms_category_brand_relation` */

insert  into `pms_category_brand_relation`(`id`,`brand_id`,`catalog_id`,`brand_name`,`catalog_name`) values 
(1,1,225,'三星','手机'),
(2,2,225,'IPhone','手机'),
(3,3,225,'华为','手机'),
(4,4,225,'小米','手机'),
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='spu属性值';
...
(1,1,1,'屏幕尺寸','6.0-6.24英寸',NULL,1),
(2,1,2,'充电功率','50-100W',NULL,0),
(3,1,3,'支持IPv6','支持IPv6',NULL,0),
(4,1,4,'电池容量','2000-2999mAh',NULL,0),
(5,1,6,'系统','iOS',NULL,0),
(6,1,7,'CPU型号','其他',NULL,0),
(7,1,5,'上市年份','2021年',NULL,0),
(8,2,1,'屏幕尺寸','6.45-6.54英寸',NULL,1),
(9,2,2,'充电功率','50-100W',NULL,0),
(10,2,3,'支持IPv6','支持IPv6',NULL,0),
(11,2,4,'电池容量','3000-3499mAh',NULL,0),
(12,2,7,'CPU型号','骁龙439',NULL,0),
(13,2,6,'系统','HarmonyOS 2',NULL,0),
(14,2,5,'上市年份','2021年',NULL,0),
(15,3,1,'屏幕尺寸','6.45-6.54英寸',NULL,1),
(16,3,2,'充电功率','50-100W',NULL,0),
(17,3,3,'支持IPv6','支持IPv6',NULL,0),
(18,3,4,'电池容量','3000-3499mAh',NULL,0),
(19,3,6,'系统','Android',NULL,0),
(20,3,7,'CPU型号','骁龙439',NULL,0),
(21,3,5,'上市年份','2021年',NULL,0),
(22,4,1,'屏幕尺寸','6.75-6.84英寸',NULL,1),
(23,4,3,'支持IPv6','支持IPv6',NULL,0),
(24,4,2,'充电功率','50-100W',NULL,0),
(25,4,4,'电池容量','3000-3499mAh',NULL,0),
(26,4,6,'系统','Android',NULL,0),
(27,4,7,'CPU型号','其他',NULL,0),
(28,4,5,'上市年份','2021年',NULL,0),
(29,5,21,'能效等级','一级能效',NULL,1),
(30,5,22,'门款式','多门;对开门',NULL,1),
(31,5,24,'制冷方式','半导体制冷',NULL,1),
(32,6,21,'能效等级','一级能效',NULL,1),
(33,6,22,'门款式','双门;对开门',NULL,1),
(34,6,24,'制冷方式','风冷',NULL,1),
(35,1,9,'保修期','2年',NULL,0),
(36,2,9,'保修期','1年',NULL,0),
(37,3,9,'保修期','2年',NULL,0),
(38,4,9,'保修期','2年',NULL,0),
(39,5,9,'保修期','2年',NULL,0),
(40,6,9,'保修期','2年',NULL,0);
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='sku图片';

/*Data for the table `pms_sku_images` */

insert  into `pms_sku_images`(`id`,`sku_id`,`img_url`,`img_sort`,`default_img`) values 
(1,1,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(2,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(3,3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(4,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(5,5,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(6,6,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(7,7,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png',NULL,1),
(8,8,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png',NULL,1),
(9,9,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png',NULL,1),
(10,10,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png',NULL,1),
(11,11,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/4ae6f8d2-0830-43b9-8e27-89bfecc0eba5_三星 SAMSUNG 心系天下W22.png',NULL,0),
(12,11,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/86efb7a7-08f9-4b9a-8d2e-7d4991f7f299_三星 SAMSUNG 心系天下W22-1.png',NULL,0),
(13,11,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/45b30454-0b85-4e30-8c44-c2567e45447e_三星 SAMSUNG 心系天下W22-2.png',NULL,1),
(14,11,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/38b8f8bf-f7f6-4630-82a8-bb6b6c133f70_三星 SAMSUNG 心系天下W22-3.png',NULL,0),
(15,12,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(16,12,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(17,12,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(18,13,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(19,13,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(20,13,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(21,14,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(22,14,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(23,14,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(24,15,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(25,15,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(26,15,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(27,16,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(28,16,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(29,16,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(30,17,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,1),
(31,17,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(32,17,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(33,18,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/3276efe8-dffa-46b9-8936-098d4b613c74_海尔（Haier）冰箱.png',NULL,1),
(34,18,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/9f230223-6f92-4024-8dbf-63281830f249_海尔（Haier）冰箱 - 1.png',NULL,0),
(35,19,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/47b7a3d9-e8df-4f2e-808f-8463248dc9b5_西门子(SIEMENS)冰箱.png',NULL,1),
(36,19,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/a0274e7b-9792-4730-855e-827dd75d8aa4_西门子(SIEMENS)冰箱- 1.png',NULL,0);
...
CREATE TABLE `pms_sku_info` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='sku信息';
...
(1,1,'Apple iPhone 13 星光色 512GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 星光色 512GB 2年','星光色 512GB',8399.0000,0),
(2,1,'Apple iPhone 13 星光色 256GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 星光色 256GB 2年','星光色 256GB',6799.0000,0),
(3,1,'Apple iPhone 13 星光色 128GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 星光色 128GB 2年','星光色 128GB',5999.0000,0),
(4,1,'Apple iPhone 13 午夜色 512GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 午夜色 512GB 2年','午夜色 512GB',8399.0000,0),
(5,1,'Apple iPhone 13 午夜色 256GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 午夜色 256GB 2年','午夜色 256GB',6799.0000,0),
(6,1,'Apple iPhone 13 午夜色 128GB 2年',NULL,225,2,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png','Apple iPhone 13 午夜色 128GB 2年','午夜色 128GB',5999.0000,0),
(7,2,'HUAWEI P50 金色 256GB 2年',NULL,225,3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png','HUAWEI P50 金色 256GB 2年','金色 256GB',4888.0000,0),
(8,2,'HUAWEI P50 金色 128GB 2年',NULL,225,3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png','HUAWEI P50 金色 128GB 2年','金色 128GB',4388.0000,0),
(9,2,'HUAWEI P50 红色 256GB 2年',NULL,225,3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png','HUAWEI P50 红色 256GB 2年','红色 256GB',4388.0000,0),
(10,2,'HUAWEI P50 红色 128GB 2年',NULL,225,3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png','HUAWEI P50 红色 128GB 2年','红色 128GB',4388.0000,0),
(11,3,'三星 SAMSUNG 心系天下W22 午夜色 512GB 2年',NULL,225,1,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/45b30454-0b85-4e30-8c44-c2567e45447e_三星 SAMSUNG 心系天下W22-2.png','三星 SAMSUNG 心系天下W22 午夜色 512GB 2年','午夜色 512GB',16999.0000,0),
(12,4,'小米12 Pro 蓝色 256GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 蓝色 256GB 2年','蓝色 256GB',4969.0000,0),
(13,4,'小米12 Pro 蓝色 128GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 蓝色 128GB 2年','蓝色 128GB',4699.0000,0),
(14,4,'小米12 Pro 绿色 256GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 绿色 256GB 2年','绿色 256GB',4969.0000,0),
(15,4,'小米12 Pro 绿色 128GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 绿色 128GB 2年','绿色 128GB',4699.0000,0),
(16,4,'小米12 Pro 午夜色 256GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 午夜色 256GB 2年','午夜色 256GB',4969.0000,0),
(17,4,'小米12 Pro 午夜色 128GB 2年',NULL,225,4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png','小米12 Pro 午夜色 128GB 2年','午夜色 128GB',4699.0000,0),
(18,5,'海尔（Haier）冰箱 2021年',NULL,252,5,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/3276efe8-dffa-46b9-8936-098d4b613c74_海尔（Haier）冰箱.png','海尔（Haier）冰箱 2021年','',3598.9000,0),
(19,6,'西门子(SIEMENS)冰箱 2021年',NULL,252,6,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/47b7a3d9-e8df-4f2e-808f-8463248dc9b5_西门子(SIEMENS)冰箱.png','西门子(SIEMENS)冰箱 2021年','',6399.0000,0);
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='sku销售属性&值';
...
(1,1,10,'颜色','星光色',NULL),
(2,1,8,'机身内存','512GB',NULL),
(3,2,10,'颜色','星光色',NULL),
(4,2,8,'机身内存','256GB',NULL),
(5,3,10,'颜色','星光色',NULL),
(6,3,8,'机身内存','128GB',NULL),
(7,4,10,'颜色','午夜色',NULL),
(8,4,8,'机身内存','512GB',NULL),
(9,5,10,'颜色','午夜色',NULL),
(10,5,8,'机身内存','256GB',NULL),
(11,6,10,'颜色','午夜色',NULL),
(12,6,8,'机身内存','128GB',NULL),
(13,7,10,'颜色','金色',NULL),
(14,7,8,'机身内存','256GB',NULL),
(15,8,10,'颜色','金色',NULL),
(16,8,8,'机身内存','128GB',NULL),
(17,9,10,'颜色','红色',NULL),
(18,9,8,'机身内存','256GB',NULL),
(19,10,10,'颜色','红色',NULL),
(20,10,8,'机身内存','128GB',NULL),
(21,11,10,'颜色','午夜色',NULL),
(22,11,8,'机身内存','512GB',NULL),
(23,12,10,'颜色','蓝色',NULL),
(24,12,8,'机身内存','256GB',NULL),
(25,13,10,'颜色','蓝色',NULL),
(26,13,8,'机身内存','128GB',NULL),
(27,14,10,'颜色','绿色',NULL),
(28,14,8,'机身内存','256GB',NULL),
(29,15,10,'颜色','绿色',NULL),
(30,15,8,'机身内存','128GB',NULL),
(31,16,10,'颜色','午夜色',NULL),
(32,16,8,'机身内存','256GB',NULL),
(33,17,10,'颜色','午夜色',NULL),
(34,17,8,'机身内存','128GB',NULL);
...
CREATE TABLE `pms_spu_images` (
  ...
  `default_img` tinyint DEFAULT '0' COMMENT '是否默认图(0表示否，1表示是)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='spu图片';

/*Data for the table `pms_spu_images` */

insert  into `pms_spu_images`(`id`,`spu_id`,`img_name`,`img_url`,`img_sort`,`default_img`) values 
(13,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/22278124-4b95-4ef2-8c4d-bd6179ac0007_苹果1.png',NULL,1),
(14,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/3524e426-3d4c-4d86-87ef-5eada7826a95_苹果1 - 副本.png',NULL,0),
(15,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/006a1b0f-aa52-42d6-866d-c4a7b728f1f3_苹果1 - 副本 (5).png',NULL,0),
(16,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/696d2cc8-cd0a-4227-8a2d-08ebe9398316_苹果1 - 副本 (4).png',NULL,0),
(17,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/2b600709-3ba3-420c-8651-271441e3a76c_苹果1 - 副本 (3).png',NULL,0),
(18,1,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/f65c32a2-09a7-43c3-85b1-f08ca5c949f4_苹果1 - 副本 (2).png',NULL,0),
(19,2,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/c5328f6a-41b6-4e68-83cc-d4b2eff95402_HUAWEI P50.png',NULL,0),
(20,2,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/dbca1c36-fcea-4235-85df-57af37b23353_HUAWEI P50-1.png',NULL,0),
(21,2,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/7bd9a3bc-c2d3-4871-8631-3af773295182_HUAWEI P50-2.png',NULL,0),
(22,3,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/4ae6f8d2-0830-43b9-8e27-89bfecc0eba5_三星 SAMSUNG 心系天下W22.png',NULL,0),
(23,3,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/86efb7a7-08f9-4b9a-8d2e-7d4991f7f299_三星 SAMSUNG 心系天下W22-1.png',NULL,0),
(24,3,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/45b30454-0b85-4e30-8c44-c2567e45447e_三星 SAMSUNG 心系天下W22-2.png',NULL,0),
(25,3,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/38b8f8bf-f7f6-4630-82a8-bb6b6c133f70_三星 SAMSUNG 心系天下W22-3.png',NULL,0),
(26,4,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/76dfd367-33b3-49a5-8939-e6428f39547e_小米12 Pro.png',NULL,0),
(27,4,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1840985f-554c-4419-8505-51b22f33d305_小米12 Pro-1.png',NULL,0),
(28,4,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/1496cafb-7126-44c1-8864-b5a909ae44d4_小米12 Pro-2.png',NULL,0),
(29,5,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/3276efe8-dffa-46b9-8936-098d4b613c74_海尔（Haier）冰箱.png',NULL,0),
(30,5,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/9f230223-6f92-4024-8dbf-63281830f249_海尔（Haier）冰箱 - 1.png',NULL,0),
(31,6,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/47b7a3d9-e8df-4f2e-808f-8463248dc9b5_西门子(SIEMENS)冰箱.png',NULL,0),
(32,6,NULL,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/a0274e7b-9792-4730-855e-827dd75d8aa4_西门子(SIEMENS)冰箱- 1.png',NULL,0);
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='spu信息';
...
(1,'Apple iPhone 13','Apple iPhone 13',225,2,0.1730,1,'2022-03-23 21:50:16','2022-03-23 21:50:16'),
(2,'HUAWEI P50','HUAWEI P50',225,3,0.1810,1,'2022-03-24 12:59:10','2022-03-24 12:59:10'),
(3,'三星 SAMSUNG 心系天下W22','三星 SAMSUNG 心系天下W22',225,1,0.2880,1,'2022-03-24 13:21:18','2022-03-24 13:21:18'),
(4,'小米12 Pro','小米12 Pro',225,4,0.2050,1,'2022-03-24 15:09:42','2022-03-24 15:09:42'),
(5,'海尔（Haier）冰箱','海尔（Haier）冰箱',252,5,72.0000,1,'2022-03-24 16:01:41','2022-03-24 16:01:41'),
(6,'西门子(SIEMENS)冰箱','西门子(SIEMENS)冰箱',252,6,110.0000,1,'2022-03-24 16:08:23','2022-03-24 16:08:23');
...
(3,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/8d60d220-2782-4636-868f-d9ac585953e7_X.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/e8657578-a1f2-44b8-8eff-385c12e17817_X - 副本.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-23/82b6ba23-0798-40ca-80f1-30e22fe4633a_X - 副本 (2).png'),
(4,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/34615208-4ca6-4282-8c6e-4c571ce7bb57_介绍.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/5fe3d1d0-f340-401d-8096-c4e9a25d1572_介绍 - 1.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/e2fcef3f-96da-4c9f-86e8-3a5017df9b33_介绍 - 2.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/7e06d8c9-3008-420e-88a3-7d1bb1b454e5_介绍 - 3.png'),
(5,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/b26b5de2-ca00-4341-8057-d721e217ab3d_介绍.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/a0bd06b9-8893-4029-88b5-ddcee8005183_介绍 - 1.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/a7de7b0e-394e-4f48-8545-859ea56e2dd3_介绍 - 2.png'),
(6,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/6276b11d-8e1d-4838-8738-713622897d80_介绍.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/74b157cf-21e0-463c-8b0d-df3a7dfbaa41_介绍 - 1.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/cc3940ff-d947-4246-885f-adb5e28ecec1_介绍 - 2.png'),
(7,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/f6bd0a7e-3f24-45a4-869a-ccd8671d09f3_介绍.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/d03dd742-70de-4e84-8f00-073e6f4875e0_介绍-1.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/2cffd020-efb1-41f0-8e01-d5efa3e09a72_介绍-2.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/5260aa61-eaf9-44df-83b3-a082d15ea21a_介绍-3.png'),
(8,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/6cd29dbe-26fe-4e53-8b8d-e02cec213ee3_介绍.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/7a18b0b9-4a39-402f-8b62-64d1e532380f_介绍-1.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/6913d130-0c96-4ed7-86ee-bd6f77e9a86b_介绍-2.png,https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-24/81c8de3b-7d06-4d1f-8584-e26ea7c51b26_介绍-3.png'),
(9,'https://online-mall-service.oss-cn-shanghai.aliyuncs.com/2022-03-28/f095448d-1e38-4f59-8400-5b54dfa42b54_下載1.jpg');
...
/*!50003 CREATE DEFINER=`root`@`%` FUNCTION `rand_string`(n INT) RETURNS varchar(255) CHARSET utf8mb4
begin 
...
/* Procedure structure for procedure `insert_dept` */

/*!50003 DROP PROCEDURE IF EXISTS  `insert_dept` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`%` PROCEDURE `insert_dept`(in start int(10),in max_num int(10))
begin
declare i int default 0; 
 set autocommit = 0;  
 repeat
 set i = i + 1;
 insert into pms_attr_attrgroup_relation values ((start+i) ,rand_string(10),rand_string(8));
  until i = max_num
 end repeat;
   commit;
 end */$$
