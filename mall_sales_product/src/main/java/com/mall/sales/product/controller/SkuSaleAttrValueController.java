...
public class SkuSaleAttrValueController {
     ...
     *  根据skuId获取属性列表
     */
    @GetMapping("/saleAttrValuelist/{skuId}")
    public List<String> getSaleAttrValuelist(@RequestParam("skuId") Long skuId){

        return skuSaleAttrValueService.getSaleAttrValuelistBySkuId(skuId);
    }
}
