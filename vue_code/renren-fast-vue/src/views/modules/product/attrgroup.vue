<template>
  <el-row :gutter="20">
    <el-col :span="6">
      <!-- 获取组件Category的事件 -->
      <category @listChildren="listChildren"></category>  
    </el-col>
    <el-col :span="18">
      <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
          <el-form-item>
            <el-input v-model="dataForm.key" placeholder="请输入分组名或id" clearable></el-input>
          </el-form-item>
          <el-form-item>
...
export default {
  ...
  methods: {
    ...
    relationHandle(groupId) {
      ...
      this.$nextTick(() => {
        //调用relationUpdate组件的方法
        this.$refs.relationUpdate.init(groupId);
      });
    },
    //感知树节点被点击
    listChildren(data, node, component) {
      if (node.level == 3) {
