<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="skuId" header-align="center" align="center" label="商品的skuId"></el-table-column>
...
export default {
  ...
  methods: {
    mergeItem() {
      ...
      if (!this.purchaseId) {
        this.$confirm(
          ...
          .then(() => {
            this.$http({
              url: this.$http.adornUrl("/houseware/purchase/merge"),
              method: "post",
    ...
    getUnreceivedPurchase() {
      this.$http({
        url: this.$http.adornUrl("/houseware/purchase/unreceive/list"),
        method: "get",
    ...
    getWares() {
      this.$http({
        url: this.$http.adornUrl("/houseware/wareinfo/list"),
        method: "get",
        params: this.$http.adornParams({
          page: 1,
          limit: 500
    ...
    getDataList() {
      ...
      this.$http({
        url: this.$http.adornUrl("/houseware/purchasedetail/list"),
        method: "get",
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle(id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl("/houseware/purchasedetail/delete"),
          method: "post",
